...
data PackageStructure = PackageStructure
  { psModules :: !(Set Module)
  -- ^ List of the exposed modules
  , psModulesMap :: !(HashMap Module ModuleStructure)
  -- ^ The pairs of the module and its parsed structure.
  }
...
newtype ModuleStructure = ModuleStructure
  { msExports :: Set Export
  -- ^ The summary list of the exported stuff.
  }
